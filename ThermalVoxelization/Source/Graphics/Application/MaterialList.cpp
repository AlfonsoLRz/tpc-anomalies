...
void MaterialList::defineMaterials()
{
	...
	_materialSpecs[CGAppEnum::MATERIAL_CAD_BLUE]._texture[Texture::KAD_TEXTURE] = CGAppEnum::TEXTURE_BLUE;
	_materialSpecs[CGAppEnum::MATERIAL_CAD_BLUE]._texture[Texture::KS_TEXTURE] = CGAppEnum::TEXTURE_GRAY_127;
	_materialSpecs[CGAppEnum::MATERIAL_CAD_BLUE]._shininess = 10.0f;
